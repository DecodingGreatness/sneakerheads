...
sneaker2.user = user1
sneaker2.photo.attach(io: File.open("app/assets/images/sneaker1.jpg"), filename: 'sneaker1.jpg', content_type: 'image/jpg')
sneaker2.save!
...
sneaker3.user = user1
sneaker3.photo.attach(io: File.open("app/assets/images/sneaker1.jpg"), filename: 'sneaker1.jpg', content_type: 'image/jpg')
sneaker3.save!
...
sneaker4.user = user2
sneaker4.photo.attach(io: File.open("app/assets/images/sneaker1.jpg"), filename: 'sneaker1.jpg', content_type: 'image/jpg')
sneaker4.save!
...
sneaker5.user = user2
sneaker5.photo.attach(io: File.open("app/assets/images/sneaker1.jpg"), filename: 'sneaker1.jpg', content_type: 'image/jpg')
sneaker5.save!
...
sneaker6.user = user1
sneaker6.photo.attach(io: File.open("app/assets/images/sneaker1.jpg"), filename: 'sneaker1.jpg', content_type: 'image/jpg')
sneaker6.save!
...
sneaker7.user = user1
sneaker7.photo.attach(io: File.open("app/assets/images/sneaker1.jpg"), filename: 'sneaker1.jpg', content_type: 'image/jpg')
sneaker7.save!
...
sneaker8.user = user1
sneaker8.photo.attach(io: File.open("app/assets/images/sneaker1.jpg"), filename: 'sneaker1.jpg', content_type: 'image/jpg')
sneaker8.save!
...
sneaker9.user = user1
sneaker9.photo.attach(io: File.open("app/assets/images/sneaker1.jpg"), filename: 'sneaker1.jpg', content_type: 'image/jpg')
sneaker9.save!
